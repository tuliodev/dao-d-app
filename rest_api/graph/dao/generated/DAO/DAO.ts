...
export class DAO extends ethereum.SmartContract {
  ...
  _proposals(param0: BigInt): DAO___proposalsResult {
    let result = super.call(
      "_proposals",
      "_proposals(uint256):(uint256,uint256,bool,bool,uint8)",
      [ethereum.Value.fromUnsignedBigInt(param0)]
    );
  ...
  execute(
    ...
    let result = super.call(
      "execute",
      "execute(uint256,address[],uint256[],bytes[],bytes32,bytes32):(bool)",
      [
  ...
  hashProposal(
    ...
    let result = super.call(
      "hashProposal",
      "hashProposal(address[],uint256[],bytes[],bytes32,bytes32):(uint256)",
      [
        ethereum.Value.fromAddressArray(targets),
        ethereum.Value.fromUnsignedBigIntArray(values),
        ethereum.Value.fromBytesArray(calldatas),
  ...
  propose(
    ...
    let result = super.call(
      "propose",
      "propose(address[],uint256[],bytes[],string,string):(uint256)",
      [
        ethereum.Value.fromAddressArray(targets),
        ethereum.Value.fromUnsignedBigIntArray(values),
        ethereum.Value.fromBytesArray(calldatas),
